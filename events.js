...
import { addLog, scheduleDiceRoll } from "ui";
...
export function setupRoomMessageHandler(room, renderSelf) {
  room.onmessage = (event) => {
    ...
    switch (data.type) {
      case "connected":
        addLog(`System`, `${data.username} joined.`, null, null, null, room);
        break;
      case "disconnected":
        addLog(`System`, `${data.username} left.`, null, null, null, room);
        break;
      case "dice-roll":
        scheduleDiceRoll(data, room);
        break;
      case "reset-complete":
        addLog("System", "The adventure was reset.", null, null, null, room);
        break;
      default:
        break;
    }
